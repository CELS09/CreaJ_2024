...
<head>
    ...
    <style>
        ...
        /* Centrar el contenido de la columna "Acción" */
        .center-align {
            text-align: center;
        }
                            ...
                            <table id="example" class="display responsive-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="200">Tipo de permiso</th>
                                        <th width="180">Fecha de publicación</th>
                                        <th>Estado</th>
                                        <th class="center-align">Acción</th> <!-- Centrar el encabezado "Acción" -->
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="center-align"> <!-- Centrar el contenido de la columna "Acción" -->
                                                    <a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid); ?>" class="waves-effect waves-light btn blue m-b-xs action-btn">Ver detalles</a>
                                                </td>
                                            </tr>
                                    <?php $cnt++;
                                        }
