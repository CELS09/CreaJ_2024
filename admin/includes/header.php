                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s5">
                            <span class="chapter-title">WorkFusion | Admin</span>
                        </div>
                      
                        <ul class="right nav-right-menu">
                        
                            <li class="hide-on-small-and-down">
                                <a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right show-on-large" style="margin-right: 10px;">
